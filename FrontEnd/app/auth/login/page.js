...
export default function login() {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-[#474747] via-[#3b3b3b] to-[#0e0e0e] bg-[length:400%_400%] animate-gradient-move p-4">
            <div className="flex flex-col items-center justify-center w-full max-w-[450px] h-[450px] mx-auto mt-[1%] p-10 pb-10 bg-[#474747] opacity-90 text-white rounded-[10px] text-[20px] shadow-2xl sora">
